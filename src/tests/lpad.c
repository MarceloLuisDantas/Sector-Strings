...
int main() {
    ...
    SString *str1pad = left_pad(str1, 3, " ");
    printf("Str Ok - \"%s\"\n", SStringToCString(str1pad));
    if (str1pad->len != 6) {
        printf("Not Ok - Should be 6, but got %d\n", str1pad->len);
        return 0;
    }
    printf("Len Ok - %d\n", str1pad->len);
    ...
    SString *str2pad = left_pad(str2, 3, "--");
    if (str2pad->len != 9) {
        printf("Not Ok - Should be 9, but got %d\n", str2pad->len);
        return 0;
    }
    printf("Len Ok - %d\n", str2pad->len);
    ...
    SString *str3pad = left_pad(str3, 3, "");
    if (str3pad->len != 3) {
        printf("Not Ok - Should be 3, but got %d\n", str3pad->len);
        return 0;
    }
    printf("Len Ok - %d\n", str3pad->len);
